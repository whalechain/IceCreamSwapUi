...
export const coreTokens = {
  ...
  usdt: new ERC20Token(ChainId.CORE, '0x81bCEa03678D1CEF4830942227720D542Aa15817', 18, 'USDT', 'Tether USD (ICE Bridge)'),
  usdc: new ERC20Token(ChainId.CORE, '0xD2683b22287E63D22928CBe4514003a92507f474', 18, 'USDC', 'USD Coin (ICE Bridge)'),
  ...
  usdtl0: new ERC20Token(ChainId.CORE, '0x900101d06A7426441Ae63e9AB3B9b0F63Be145F1', 6, 'USDT_L0', 'Tether USD (CORE Bridge)'),
  usdcl0: new ERC20Token(ChainId.CORE, '0xa4151B2B3e269645181dCcF2D426cE75fcbDeca9', 6, 'USDC_L0', 'USD Coin (CORE Bridge)'),

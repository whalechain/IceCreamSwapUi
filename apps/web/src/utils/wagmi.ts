...
import {bitgert, bsc, dogechain, dokenchain, fuse, xdc, shardeumTestnet, mainnet} from '@pancakeswap/wagmi/chains'
...
const CHAINS = [bitgert, dogechain, dokenchain, fuse, xdc, shardeumTestnet, bsc]

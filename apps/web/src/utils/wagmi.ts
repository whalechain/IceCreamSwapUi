...
import {bitgert, bsc, dogechain, dokenchain, fuse, xdc, mainnet, core} from '@pancakeswap/wagmi/chains'
...
const CHAINS = [bitgert, dogechain, dokenchain, fuse, xdc, bsc, core]

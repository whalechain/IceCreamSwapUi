...
export const INFO_CLIENT_XDC = 'https://graph-xdc.icecreamswap.dev/subgraphs/name/icecreamswap/exchange-xdc'
export const BLOCKS_CLIENT_XDC = 'https://graph-xdc.icecreamswap.dev/subgraphs/name/icecreamswap/blocks-xdc'

...
export const ROUTER_ADDRESS_COMMON_AKKA_CORE_ALTERNATE = '0x493b4cD63Ec250AEA097168248f87338E7F90134'
...
export const ROUTER_ADDRESS: Partial<ChainMap<RouterAddressTypes>> = {
  ...
  [ChainId.CORE]: {
    ...
    AkkaAlternate: ROUTER_ADDRESS_COMMON_AKKA_CORE_ALTERNATE
  },
  [ChainId.XODEX]: {
    Icecream: ROUTER_ADDRESS_COMMON,
  },

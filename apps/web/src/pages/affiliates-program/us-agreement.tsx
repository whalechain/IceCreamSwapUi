    ...
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          ...
          Program (“Program”). In this Agreement, “<strong>WhaleChain</strong>,” “<strong>we</strong>” or “
        ...
        <Text as="p">
          ...
          any of WhaleChain’s services (including but not limited to V2, V3 swapping services, perpetual trading,
          Non-Fungible Tokens and related services, initial farm offerings and similar offerings) (“WhaleChain
          Services”).
        </Text>
        ...
        <Text as="p">
          7.3 Any statements you make about WhaleChain must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          13.1 WhaleChain reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          13.2 WhaleChain, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">13.3 WhaleChain reserves the right to refuse service to anyone for any reason at any time.</Text>
        ...
        <Text as="p">
          (f) Conduct marketing or make any representations of any WhaleChain products and services to users in the
